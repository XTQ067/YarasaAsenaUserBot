...
@register(outgoing=True, pattern="^.[eə]lav[əe] ?(.*)")
...
CmdHelp('admin').add_command(
        ...
        'ban', ("<istifadəçi adı/cavablama> <səbəbi (istəyə bağlı)>"), ("Söhbətdəki istifadəçini banlayar.")
    ).add_command(
        'unban', ("<istifadəçi adı/cavablama>"), ("Söhbətdəki istifadəçinin bandan çıxardar.")
    ).add_command(
        'mute', ("<istifadəçi adı/cavablama>"), ("Söhbətdəki istifadəçimi susdurar, idarəçilərədə işləyir.")
    ).add_command(
        'unmute', ("<istifadəçi adı/cavablama> <səbəbi (istəyə bağlı)>"), ("Səssizdən çıxarar.")
    ).add_command(
        'kick', ("<istifadəçi adı/cavablama> <səbəbi (istəyə bağlı)>"), ("Seçdiyiniz istifadəçini qrupdan atar. (Ban etməz)")
    ).add_command(
        ...
        'bots', None, ("Qrupdakı botları göstərər.")
    ).add_command(
        'users', None, ("Söhbətdəki bütün istifadəçiləri göstərər.")
    ).add_command(
        ...
        'unwarn', ("<istifadəçi adı/cavablamma>"), ("Seçdiyiniz istifadəçinin xəbərdarlığını silər.")
    ).add_command(
        'add', ("<istifadəçi adı>"), ("Qrupa istifadəçi əlavə edər.")
    ).add_command(
